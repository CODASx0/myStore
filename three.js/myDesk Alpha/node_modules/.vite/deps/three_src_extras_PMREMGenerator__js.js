...
var Box3 = class {
    ...
    if (geometry !== void 0) {
      if (precise && geometry.attributes != void 0 && geometry.attributes.position !== void 0) {
        ...
        for (let i = 0, l = position.count; i < l; i++) {
          _vector3.fromBufferAttribute(position, i).applyMatrix4(object.matrixWorld);
  ...
  distanceToPoint(point) {
    const clampedPoint = _vector3.copy(point).clamp(this.min, this.max);
...
var Ray = class {
  ...
  distanceSqToPoint(point) {
    ...
    _vector5.copy(this.direction).multiplyScalar(directionDistance).add(this.origin);
...
//# sourceMappingURL=three_src_extras_PMREMGenerator__js.js.map
